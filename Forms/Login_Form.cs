...
namespace NT106_Nhom12_Pro.Forms
{
    public partial class Login_Form : Form
    {
        ...
        // Phương thức Login_Form_FormClosing
        ...
        private void Initialize_Custom_Components()
        {
            ...
            register_Link_Label.Click += Register_Link_Label_Click;
            ...
            register_Link_Label.MouseEnter += (s, e) =>
            {
                register_Link_Label.ForeColor = Theme_Manager.Is_Light_Mode
                    ? Theme_Colors.Light_Mode.Link_Hover
                    : Theme_Colors.Dark_Mode.Link_Hover;
            };

            register_Link_Label.MouseLeave += (s, e) =>
            {
                register_Link_Label.ForeColor = Theme_Manager.Is_Light_Mode
        ...
        private void Apply_Theme()
        {
            if (Theme_Manager.Is_Light_Mode)
            {
                ...
                register_Text_Label.ForeColor = Theme_Colors.Light_Mode.Text_Muted;
                ...
                register_Link_Label.ForeColor = Theme_Colors.Light_Mode.Link_Color;
            }
            else
            {
                ...
                register_Text_Label.ForeColor = Theme_Colors.Dark_Mode.Text_Muted;
                ...
                register_Link_Label.ForeColor = Theme_Colors.Dark_Mode.Link_Color;
            }
        ...
        private void Register_Link_Label_Click(object sender, EventArgs e)
        {
            this.Hide();
            Register_Form register_Form = new Register_Form();
            register_Form.FormClosed += (s, args) => this.Close();
            register_Form.Show();
        }
    }
}
