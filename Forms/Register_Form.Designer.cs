...
namespace NT106_Nhom12_Pro.Forms
{
    partial class Register_Form
    {
        ...
        private System.Windows.Forms.Label login_Text_Label;
        private System.Windows.Forms.Label login_Link_Label;
        ...
        private void InitializeComponent()
        {
            ...
            login_Text_Label = new Label();
            login_Link_Label = new Label();
            ...
            left_Panel.Controls.Add(login_Text_Label);
            left_Panel.Controls.Add(login_Link_Label);
            left_Panel.Controls.Add(register_Button);
            ...
            left_Panel.Margin = new Padding(5, 4, 5, 4);
            left_Panel.Name = "left_Panel";
            left_Panel.Size = new Size(800, 1055);
            left_Panel.TabIndex = 0;
            login_Text_Label.BackColor = Color.Transparent;
            login_Text_Label.Font = new Font("Segoe UI", 10F);
            login_Text_Label.ForeColor = Color.FromArgb(120, 120, 120);
            login_Text_Label.Location = new Point(94, 908);
            login_Text_Label.Margin = new Padding(5, 0, 5, 0);
            login_Text_Label.Name = "login_Text_Label";
            login_Text_Label.Size = new Size(346, 39);
            login_Text_Label.TabIndex = 10;
            login_Text_Label.Text = "Already have an account? ";
            login_Text_Label.TextAlign = ContentAlignment.MiddleRight;
            login_Link_Label.BackColor = Color.Transparent;
            login_Link_Label.Cursor = Cursors.Hand;
            login_Link_Label.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            login_Link_Label.ForeColor = Color.FromArgb(0, 102, 204);
            login_Link_Label.Location = new Point(449, 908);
            login_Link_Label.Margin = new Padding(5, 0, 5, 0);
            login_Link_Label.Name = "login_Link_Label";
            login_Link_Label.Size = new Size(257, 39);
            login_Link_Label.TabIndex = 11;
            login_Link_Label.Text = "Login";
            login_Link_Label.TextAlign = ContentAlignment.MiddleLeft;
            register_Button.BackColor = Color.FromArgb(124, 58, 237);
            register_Button.Cursor = Cursors.Hand;
            register_Button.FlatAppearance.BorderSize = 0;
            register_Button.FlatStyle = FlatStyle.Flat;
            register_Button.Font = new Font("Segoe UI", 12F, FontStyle.Bold);
            register_Button.ForeColor = Color.White;
            register_Button.Location = new Point(94, 800);
            register_Button.Margin = new Padding(5, 4, 5, 4);
            register_Button.Name = "register_Button";
            register_Button.Size = new Size(614, 77);
            register_Button.TabIndex = 9;
            register_Button.Text = "Register with us";
            ...
            password_TextBox.Margin = new Padding(5, 4, 5, 4);
            ...
            email_TextBox.Margin = new Padding(5, 4, 5, 4);
            ...
            email_Label.Margin = new Padding(5, 0, 5, 0);
            ...
            subtitle_Label.Margin = new Padding(5, 0, 5, 0);
            subtitle_Label.Name = "subtitle_Label";
            subtitle_Label.Size = new Size(600, 39);
            subtitle_Label.TabIndex = 3;
            subtitle_Label.Text = "NetWare - Hãy nói theo cách của bạn";
            ...
            welcome_Label.Margin = new Padding(5, 0, 5, 0);
            welcome_Label.Name = "welcome_Label";
            welcome_Label.Size = new Size(697, 77);
            welcome_Label.TabIndex = 2;
            welcome_Label.Text = "Welcome to NetWare👋";
            ...
            logo_Label.Margin = new Padding(5, 0, 5, 0);
            ...
            logo_Picture.Margin = new Padding(5, 4, 5, 4);
            ...
            theme_Toggle_Button.Margin = new Padding(5, 4, 5, 4);
            ...
            carousel_Panel.Margin = new Padding(5, 4, 5, 4);
